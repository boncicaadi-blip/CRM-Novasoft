  ...
  return (
    <div className="rounded-xl border border-[#E8007A]/20 bg-[#E8007A]/[0.02] p-4">
      <div className="mb-3 flex items-center gap-1.5">
        ...
        <p className="text-sm font-medium text-white">Compozitie pe luni</p>
      </div>
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            {sortate.map((m) => (
              <tr key={m.luna} className="border-b border-white/5">
                ...
                <td
                  className={`px-2 py-1.5 text-right font-mono ${
                    m.venitRealizat - m.cheltuieliRealizat >= 0 ? "text-white" : "text-red-400"
                  }`}
                >
