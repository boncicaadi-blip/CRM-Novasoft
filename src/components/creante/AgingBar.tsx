...
import type { CreanteSummary } from "@/lib/creante-analytics";

const BUCKETS: { key: keyof CreanteSummary; label: string; color: string }[] = [
...
export function AgingBar({ summary }: { summary: CreanteSummary }) {
  const total =
    summary.sold0_30 + summary.sold31_60 + summary.sold61_90 + summary.sold90Plus;
