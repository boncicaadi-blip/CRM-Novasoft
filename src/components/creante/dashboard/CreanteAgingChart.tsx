  ...
  return (
    <div className="rounded-xl border border-border-subtle bg-surface-1 p-4">
      <div className="mb-3 flex items-center justify-between">
        <p className="flex items-center gap-1.5 text-sm font-medium text-text-primary">Vechime sold restant (aging)<InfoTooltip title="Vechime sold (aging)" definition={CREANTE_KPI_DEFINITIONS.agingChart} /></p>
      </div>
